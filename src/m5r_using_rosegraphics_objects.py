...
#            myWindow = rg.RoseWindow(800,100)
#
...
#                center , outline_color , fill_color
#
#     f. What does a RoseWindow RENDER method do?
#            displays all objects which have been attached to it
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            When all changes the the window have been made. It makes the
# program wait to continue or close the window until the user clicks it.
#
